...
# Impostazione della finestra per il fullscreen
...
while True:
    ...
    if len(faces) > 0:
        ...
        if len(eyes) >= 2:
            ...
            sub_frame2 = cv2.resize(sub_frame2, (width, height))

            # Mostro la sotto-porzione della webcam 2 in modalità fullscreen
            cv2.imshow("Tracking", sub_frame2)

    # Uscita dal ciclo con il tasto 'q'
