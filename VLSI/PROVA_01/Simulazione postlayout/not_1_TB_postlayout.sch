...
C {devices/vsource.sym} -530 70 0 0 {name=V1 value=1.8 savecurrent=false}
C {devices/vsource.sym} -460 70 0 0 {name=vin value=0 savecurrent=false}
...
C {devices/code_shown.sym} -330 -130 0 0 {name=VTC1 only_toplevel=false value=".include /home/rr/Documents/WORKSPACE/GIT_REPOSITORY/VLSI/PROVA_01/Simulazione postlayout/not_1.spice
